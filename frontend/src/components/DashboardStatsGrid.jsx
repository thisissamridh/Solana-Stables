...
export default function DashboardStatsGrid() {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      <BoxWrapper>
        <div className="rounded-full h-8 md:h-12 w-8 md:w-12 flex items-center justify-center bg-sky-500">
          <IoBagHandle className="text-xl md:text-2xl text-white" />
        </div>
        <div className="pl-2 md:pl-4">
          <span className="text-xs md:text-sm text-gray-500 font-light">Stablecoin Supply</span>
      ...
      <BoxWrapper>
        <div className="rounded-full h-8 md:h-12 w-8 md:w-12 flex items-center justify-center bg-orange-600">
          <IoPieChart className="text-xl md:text-2xl text-white" />
        </div>
        <div className="pl-2 md:pl-4">
          <span className="text-xs md:text-sm text-gray-500 font-light">Stablecoin TVL</span>
          <div className="flex items-center">
      ...
      <BoxWrapper>
        ...
        <div className="pl-2 md:pl-4">
          <span className="text-xs md:text-sm text-gray-500 font-light">TVL Change 7D</span>
          <div className="flex items-center">
      ...
      <BoxWrapper>
        ...
        <div className="pl-2 md:pl-4">
          <span className="text-xs md:text-sm text-gray-500 font-light">USDC Dominance</span>
          <div className="flex items-center">
...
function BoxWrapper({ children }) {
  return (
    <div className="bg-black-gradient rounded-md p-3 md:p-4 flex flex-col md:flex-row items-center shadow-xl">
      {children}
    </div>
  )
}
