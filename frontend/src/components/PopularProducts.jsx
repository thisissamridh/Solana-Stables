...
const popularProducts = [
  ...
  },
  {
    id: '9234',
    product_name: 'xyz',
    product_thumbnail: 'https://plus.unsplash.com/premium_photo-1688700438084-1936c52670df?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWgefHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80',
...
function PopularProducts() {
  return (
      <div className="w-full md:w-[20rem] bg-black-gradient p-4 rounded-md shadow-xl">
          <strong className="text-white-700 font-bold text-gradient">#Top 100 Stablecoin Holder</strong>
          <div className="mt-4 flex flex-col gap-3 overflow-y-auto scrollbar-hide">
